...
SET SEARCH_PATH="%ProgramFiles%\ST"
...
cls
IF "%ERRORLEVEL%"=="1" SET PROFILE="BOARDS\Custom\DXCHMEI_2020" && SET DISPLAY="SSD1306"&& GOTO :ASKCUBEMX
IF "%ERRORLEVEL%"=="2" SET PROFILE="BOARDS\Custom\KSGER_GX_V2.1S" && SET DISPLAY="SSD1306"&& GOTO :ASKCUBEMX
IF "%ERRORLEVEL%"=="3" SET PROFILE="BOARDS\Custom\XinYue_JBC_V2.1S" && SET DISPLAY="SSD1306"&& GOTO :ASKCUBEMX
IF "%ERRORLEVEL%"=="4" SET PROFILE="" && SET RUN_CUBEMX="y" && SET COMPILE="y" && SET DISPLAY=""&& GOTO :TOOLS
