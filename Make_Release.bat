...
copy "..\BOARDS\KSGER\v1.5\STM32F103\SSD1306_CH.bin"	"KSGER_v1_5_OLED_CH.bin" >nul				&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v1.5\STM32F103\SSD1306_CH.list"	"KSGER_v1_5_OLED_CH.list" >nul				&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v1.5\STM32F103\ST7565_CH.bin" 	"KSGER_v1_5_LCD_ST7565_CH.bin" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v1.5\STM32F103\ST7565_CH.list" 	"KSGER_v1_5_LCD_ST7565_CH.list" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v2\STM32F101\SSD1306_CH.bin" 	"KSGER_v2_OLED_CH.bin" >nul				&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v2\STM32F101\SSD1306_CH.list" 	"KSGER_v2_OLED_CH.list" >nul				&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v3\STM32F101\SSD1306_CH.bin" 	"KSGER_v3_OLED_CH.bin" >nul				&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v3\STM32F101\SSD1306_CH.list" 	"KSGER_v3_OLED_CH.list" >nul				&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v3\STM32F101\ST7565_CH.bin" 	"KSGER_v3_LCD_ST7565_CH.bin" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\KSGER\v3\STM32F101\ST7565_CH.list" 	"KSGER_v3_LCD_ST7565_CH.list" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F072\SSD1306_CH.bin" 	"Quicko_STM32F072_OLED_CH.bin" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F072\SSD1306_CH.list" 	"Quicko_STM32F072_OLED_CH.list" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F072\ST7565_CH.bin" 	"Quicko_STM32F072_LCD_ST7565_CH.bin" >nul		&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F072\ST7565_CH.list" 	"Quicko_STM32F072_LCD_ST7565_CH.list" >nul		&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F103\SSD1306_CH.bin" 	"Quicko_STM32F103_OLED_CH.bin" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F103\SSD1306_CH.list" 	"Quicko_STM32F103_OLED_CH.list" >nul			&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F103\ST7565_CH.bin" 	"Quicko_STM32F103_LCD_ST7565_CH.bin" >nul		&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
copy "..\BOARDS\Quicko\STM32F103\ST7565_CH.list" 	"Quicko_STM32F103_LCD_ST7565_CH.list" >nul		&& IF %ERRORLEVEL% NEQ 0 GOTO :NO_FILES
...
IF "%FILE:~-3%" NEQ "_CH" (
  ...
  REM %ZIP% a -mx=9 -tzip FLASH_TEST_%FILE%.zip %FILE%.bin -y >nul
)
